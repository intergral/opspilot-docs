...
A **Runs over time** chart stacks activity across the period, coloured by task alongside the held-off categories (allowance and paced). The legend below the chart identifies each task and the held-off types.
